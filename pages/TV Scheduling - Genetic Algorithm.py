...
MUT_R = st.slider("Mutation Rate (MUT_R):", min_value=0.01, max_value=0.05, value=0.2, step=0.01)

st.write(f"Selected Crossover Rate: {CO_R}")
st.write(f"Selected Mutation Rate: {MUT_R}")
